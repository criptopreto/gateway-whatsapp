...
} = require("../constants/emailTypes");
const { createToken } = require("../jwt");
const { Mailer } = require("./mailer");

class OTPMailer extends Mailer {
  constructor(to, code, type) {
    super();

    this.mailOptions = {
      from: process.env.EMAIL_FROM,
      to,
      subject: process.env.EMAIL_SUBJECT_DEFAULT,
      html:
        type === WELCOME_EMAIL
          ? this.buildWelcomeHTML(to, code)
          : type === ACCOUNT_RECOVERY_EMAIL
          ? this.buildRecoveryAccountHTML(to, code)
          : this.buildChangePasswordHTML(to, code),
      ...this.mailOptions,
    };
  }

  buildWelcomeHTML(to, code) {
    let payload = {
      email: to,
      otp: code,
    };
                                            ...
                                            >
                                              <span
                                                style="
                                                  ...
                                                  display: flex;
                                                "
                                                >${process.env.EMAIL_APP_TITLE}</span
                                              >
                                            </div>
                                          </td>
                                        </tr>
                                  ...
                                  >
                                    ...
                                    >
                                      <div>
                                        ...
                                        de que pueda acceder a ${process.env.EMAIL_APP_TITLE}®.
                                        Vaya al link:
                                      </div>
                                    </div>
                                  </td>
                                    ...
                                    >
                                      <tbody>
                                        <tr>
                                          ...
                                          >
                                            <a
                                              href="${process.env.EMAIL_ACTIVATION_HOST}/validate/${token}"
                                              style="
                                                display: inline-block;
                                                background: #c4e0ff;
                                                color: #1f247e;
                                ...
                                <tr>
                                  ...
                                  >
                                    <div
                                      ...
                                      "
                                    >
                                      © 2022 ${process.env.EMAIL_APP_TITLE}, All Rights
                                      Reserved.
                                    </div>
                                  </td>
                                </tr>
  ...
  buildRecoveryAccountHTML(to, code) {
    let payload = {
      email: to,
      otp: code,
    };
                                ...
                                <tr>
                                  ...
                                  >
                                    <div
                                      ...
                                      "
                                    >
                                      © 2023 ${process.env.EMAIL_APP_TITLE}, All Rights
                                      Reserved.
                                    </div>
                                  </td>
                                </tr>
  ...
  buildChangePasswordHTML(to, code) {
    let payload = {
      email: to,
      otp: code,
    };
